        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-24">
          <div className="lg:col-span-5">
            ...
            <div className="flex gap-4">
              {[
                { icon: Twitter, href: SITE_DATA.contact.twitter },
                { icon: Instagram, href: SITE_DATA.contact.instagram },
                { icon: Facebook, href: SITE_DATA.contact.facebook },
              ].map((social, i) => (
                <a 
                  key={i} 
                  href={social.href} 
          ...
          <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-4">
                {SITE_DATA.footerLinks.company.map(item => (
                  <li key={item.name}>
                    <a href={item.href} className="text-vicce-charcoal/60 hover:text-vicce-accent transition-colors">
                      {item.name}
                    </a>
                  </li>
                ))}
