...
// ... rest of the config
  ...
  stats: [
    {
      icon: "verified",
      title: "100% Arabica",
      description: "Carefully selected premium beans from single-origin high-altitude farms."
    },
    {
      icon: "eco",
      title: "Sustainably Sourced",
      description: "Directly traded relationships that empower growers and protect the soil."
    },
    {
      icon: "local_fire_department",
      title: "Artisanal Roast",
      description: "Small-batch roasted in Austin to unlock complex, nuanced profiles."
    }
  ],
  philosophy: {
  ...
  story: {
    ...
    quote: "Brew & Co was born from a simple obsession: why can't home-brewed coffee taste as vibrant as a professional pour-over?",
    description: "What started as a garage experiment in roasting became a mission to democratize specialty coffee. We travel to origin, meet the farmers, and bring back more than just beans—we bring back stories that deserve to be told in every cup.",
  ...
  journal: {
    ...
    items: [
      ...
      {
        alt: "Cafe exterior",
        img: "https://lh3.googleusercontent.com/aida-public/AB6AXuDV5StGtJyLv_sKJih6SOLenqXSvFL71_ZNqG3eDAKoi_tZ8DkcgQiNkIfoiVE-VaKIrJeJb9dNpHzIgiR3aOPwMgf3ryUeLalZmgHCx2z7Byh1Z4JIxHltQ2CuWhw-7XYCi-QGnLWfKnT00BGRKBQ5rf0d3vNfj1vCXa1jqw0M-mIvWcbCRC3Yw2sKyRxgGP96T6m0z6LENYkh-tj1wAXDqOT4Q4pHfpsqeftU5qK8NRAgZQlA_Tst_QWJCKa3pHx8b2cF6hVtzE4g",
  ...
  footer: {
    description: "Redefining the coffee ritual through artisanal craftsmanship and scientific precision. Based in Austin, Texas.",
    socials: [
      { icon: "public", href: "#" },
    ...
    newsletter: {
      title: "Briefing",
      description: "Subscribe for brew guides and limited drops."
    },
    copyright: "© 2024 Brew & Co. Coffee Roasters. All rights reserved."
  }
};
