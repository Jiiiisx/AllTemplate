    ...
    <section className="py-24 lg:py-48 bg-white" id="shop">
      <div className="max-w-[1400px] mx-auto px-6 md:px-10">
        ...
        <div className="mt-32 text-center">
          <button className="px-12 py-5 border border-espresso/20 text-[11px] tracking-[0.4em] font-bold uppercase hover:bg-espresso hover:text-white transition-all">{shop.cta}</button>
        </div>
      </div>
    </section>
  );
