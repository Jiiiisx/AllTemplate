export const siteData = {
  ...
  description: "Savor the finest coffee in a modern atmosphere. Crafting every drop with precision and passion. Experience the art of modern brewing in the heart of the city.",
  ...
  hero: {
    title: "COFFEE SHOP",
    subtitle: "Crafting every drop with precision and passion. Experience the art of modern brewing in the heart of the city.",
  ...
  menu: {
    title: "What are you craving of?",
    categories: ["All", "Coffee", "Non-Coffee", "Snacks"],
    promo: {
      title: "Today's Promo",
