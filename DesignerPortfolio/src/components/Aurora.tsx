...
void main() {
  ...
  if (uv.x < 0.5) {
    ...
    rampColor = mix(colors[1].color, colors[2].color, (uv.x - 0.5) * 2.0);
  }
...
export default function Aurora(props: any) {
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      program.uniforms.uColor1.value.set(stops[0]);
      program.uniforms.uColor2.value.set(stops[1]);
      program.uniforms.uColor3.value.set(stops[2]);
