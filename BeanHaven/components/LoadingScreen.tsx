    ...
    <div className={`fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-darkRoast transition-opacity duration-500 ${fadeOut ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
      <div className="flex flex-col items-center">
        ...
        <div className="text-center flex flex-col items-center">
          <h2 className="text-white font-black tracking-[0.3em] text-[10px] md:text-xs mb-4 uppercase">Preparing Your Brew</h2>
          ...
          <span className="mt-4 text-white/20 text-[8px] font-bold tracking-[0.4em] uppercase">BeanHaven Artisanal</span>
        </div>
      </div>
