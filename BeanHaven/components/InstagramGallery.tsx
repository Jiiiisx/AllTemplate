...
const InstagramGallery: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-white dark:bg-secondary transition-colors duration-300 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 mb-12 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <ScrollAnimation direction="right">
          ...
          <h2 className="text-4xl font-black text-secondary dark:text-white mt-2">Captured Moments</h2>
        </ScrollAnimation>
        <ScrollAnimation direction="left">
          <a href="#" className="text-secondary dark:text-white font-bold border-b-2 border-primary pb-1 hover:text-primary transition-colors">
            @beanhaven.official
          </a>
        </ScrollAnimation>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 px-4">
        {posts.map((url, index) => (
          <ScrollAnimation 
            ...
            delay={index * 0.1}
          >
            <div className="aspect-square relative group cursor-pointer overflow-hidden rounded-2xl">
              <img 
                src={url} 
